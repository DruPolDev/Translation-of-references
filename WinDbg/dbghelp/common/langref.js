...
function ShowNewTip(tipIdentifier)
{
	...
	w = tip.offsetWidth;
	h = tip.offsetHeight;
	currentPixelWidth = tip.style.pixelWidth;
	currentPixelHeight = tip.style.pixelHeight;			
	window.event.returnValue = false;
	window.event.cancelBubble = true;
...
{
	var tips = document.all(tipIdentifier);
	var tip = null;
	var link = window.linkElement;
	var i = 0;
